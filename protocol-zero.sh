...
# Repository: Ottie Express (iOS / SwiftUI)
#
...
#
# Usage:
#   ./protocol-zero.sh              # Scan entire codebase
#   ./protocol-zero.sh --commit-msg "message"   # Validate commit message
#   ./protocol-zero.sh --commit-msg-file path   # Validate commit message from file
...
# Aligned to iOS/Xcode toolchain; no JS ecosystem directories present in this repo
EXCLUDE_DIRS=(
    ".git"
    "build"
    "dist"
...
# Governance, CI, and documentation paths that may reference prohibited patterns legitimately
...
# Includes iOS-specific binary formats: m4a/aac (primary audio per design doc),
# ipa (app archive), car (compiled asset catalog), mobileprovision (signing)
BINARY_EXTENSIONS=(
...
scan_codebase() {
    ...
    # Exclusions mirror EXCLUDE_DIRS and common binary extensions for this iOS project
